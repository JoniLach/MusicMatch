...
namespace MusicMatch
{
    ...
    // Returns Visible when the int value is 0 (not yet rated), Collapsed when already rated (> 0)
    ...
    // Returns Collapsed when 0, Visible when rated (> 0) — used to show "Rated ★N" text
